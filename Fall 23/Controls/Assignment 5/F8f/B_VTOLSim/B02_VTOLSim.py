import sys
sys.path.append('.')
sys.path.append('C:/Users/spenc/Documents/School/Fall 23/Controls/Assignment 5/F8f')
...
# theta
tr_th = 0.8 # stays the same, not tuning this
wn_th = 2.2/tr_th
b = 2*dr*wn_th
c = wn_th**2
control.kDtheta = b*(P.jc + 2*P.mr*P.d**2)
control.kPtheta = c*(P.jc + 2*P.mr*P.d**2)
